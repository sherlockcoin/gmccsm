...
__constant__ const uint32_t d_m_data[8] = {
    0xd0364141, 0xbfd25e8c, 0xaf48a03b, 0xbaaedce6, 
    0xfffffffe, 0xffffffff, 0xffffffff, 0xffffffff
};

__constant__ const uint32_t d_mu_data[9] = {
    0x2fc9bec0, 0x402da173, 0x50b75fc4, 0x45512319, 
    0x00000001, 0x00000000, 0x00000000, 0x00000000, 
    0x00000001
};

__global__ void spreadx11_sign_gpu(int threads, uint32_t startNonce, uint32_t *g_sha256hash, uint32_t *g_signature )
{
...
__host__ void spreadx11_sign_cpu_init( int thr_id, int throughput )
{
}

__host__ void spreadx11_sign_cpu_setInput( struct work *work )
{
...
__host__ void spreadx11_sign_cpu(int thr_id, int threads, uint32_t startNonce, uint32_t *d_hash, uint32_t *d_signature)
{
