...
#define TPB_88_50 1024
#define TPB_88_52 1024
...
// init vector
static __constant__ const uint32_t d_IV[8] = {
...
// round constants
static __constant__ __align__(8) uint32_t d_K[64] = {
...
static __constant__ const uint32_t padding400000[16] = {
...
static __constant__ const uint32_t padding32[16] = {
    0x80000000, 0x00000000, 0x00000000, 0x00000000,
...
__device__ __host__ __forceinline__ void sha2_step1( uint32_t *W, const uint32_t *K, const uint32_t a, const uint32_t b, const uint32_t c, uint32_t &d, 
	...
	W[pc] = in[pc];
	const uint32_t t1 = h + BSG2_1(e) + CH(e, f, g) + K[pcount + pc] + W[pc];
	h = t1 + BSG2_0(a) + MAJ(a, b, c);
	d += t1;    
}
__device__ __host__ __forceinline__ void sha2_step1_swab32( uint32_t *W, const uint32_t *K, const uint32_t a, const uint32_t b, const uint32_t c, uint32_t &d, 
    const uint32_t e, const uint32_t f, const uint32_t g, uint32_t &h, const uint32_t *in, const uint32_t pc, const uint32_t pcount ){
...
__device__ __host__ __forceinline__ void sha2_step2( uint32_t *W, const uint32_t *K, const uint32_t a, const uint32_t b, const uint32_t c, uint32_t &d, 
	...
	W[pc] = SSG2_1(W[(pc - 2) & 0x0F]) + W[(pc - 7) & 0x0F] + SSG2_0(W[(pc - 15) & 0x0F]) + W[pc];
...
void sha2_transform( const uint32_t *in, uint32_t *state ){
    ...
    sha2_step1(w, d_K, a, b, c, d, e, f, g, h, in,  0, 0);
    sha2_step1(w, d_K, h, a, b, c, d, e, f, g, in,  1, 0);
    sha2_step1(w, d_K, g, h, a, b, c, d, e, f, in,  2, 0);
    sha2_step1(w, d_K, f, g, h, a, b, c, d, e, in,  3, 0);
    sha2_step1(w, d_K, e, f, g, h, a, b, c, d, in,  4, 0);
    sha2_step1(w, d_K, d, e, f, g, h, a, b, c, in,  5, 0);
    sha2_step1(w, d_K, c, d, e, f, g, h, a, b, in,  6, 0);
    sha2_step1(w, d_K, b, c, d, e, f, g, h, a, in,  7, 0);
    sha2_step1(w, d_K, a, b, c, d, e, f, g, h, in,  8, 0);
    sha2_step1(w, d_K, h, a, b, c, d, e, f, g, in,  9, 0);
    sha2_step1(w, d_K, g, h, a, b, c, d, e, f, in, 10, 0);
    sha2_step1(w, d_K, f, g, h, a, b, c, d, e, in, 11, 0);
    sha2_step1(w, d_K, e, f, g, h, a, b, c, d, in, 12, 0);
    sha2_step1(w, d_K, d, e, f, g, h, a, b, c, in, 13, 0);
    sha2_step1(w, d_K, c, d, e, f, g, h, a, b, in, 14, 0);
    sha2_step1(w, d_K, b, c, d, e, f, g, h, a, in, 15, 0);
    
	#pragma unroll 3
	for (int pcount = 16; pcount < 64; pcount += 16){
...
__device__ __forceinline__ 
void sha2_transform_swab32( const uint32_t *const __restrict__ in, uint32_t *state ){
	...
	*(uint2x4*)&w[ 0] = swapvec(*(uint2x4*)&in[ 0]);
	*(uint2x4*)&w[ 8] = swapvec(*(uint2x4*)&in[ 8]);
//	#pragma unroll 16
//	for(int i=0;i<16;i++){
//		w[i ] = cuda_swab32(in[ i]);
//	}

	sha2_step1_swab32(w, d_K, a, b, c, d, e, f, g, h, in,  0, 0);
	sha2_step1_swab32(w, d_K, h, a, b, c, d, e, f, g, in,  1, 0);
	sha2_step1_swab32(w, d_K, g, h, a, b, c, d, e, f, in,  2, 0);
	sha2_step1_swab32(w, d_K, f, g, h, a, b, c, d, e, in,  3, 0);
	sha2_step1_swab32(w, d_K, e, f, g, h, a, b, c, d, in,  4, 0);
	sha2_step1_swab32(w, d_K, d, e, f, g, h, a, b, c, in,  5, 0);
	sha2_step1_swab32(w, d_K, c, d, e, f, g, h, a, b, in,  6, 0);
	sha2_step1_swab32(w, d_K, b, c, d, e, f, g, h, a, in,  7, 0);
	sha2_step1_swab32(w, d_K, a, b, c, d, e, f, g, h, in,  8, 0);
	sha2_step1_swab32(w, d_K, h, a, b, c, d, e, f, g, in,  9, 0);
	sha2_step1_swab32(w, d_K, g, h, a, b, c, d, e, f, in, 10, 0);
	sha2_step1_swab32(w, d_K, f, g, h, a, b, c, d, e, in, 11, 0);
	sha2_step1_swab32(w, d_K, e, f, g, h, a, b, c, d, in, 12, 0);
	sha2_step1_swab32(w, d_K, d, e, f, g, h, a, b, c, in, 13, 0);
	sha2_step1_swab32(w, d_K, c, d, e, f, g, h, a, b, in, 14, 0);
	sha2_step1_swab32(w, d_K, b, c, d, e, f, g, h, a, in, 15, 0);
...
__launch_bounds__(TPBw52, BNDw52)
#else
__launch_bounds__(TPBw50, BNDw50) 
#endif
...
*/
	...
	for( int round = 0; round < 2; round++ ){
		...
		#pragma unroll 12
		for( int i=1; i < 12; i++ ) input[i] = g_input[i];

		#pragma unroll 19
		for( int i = 0; i < 19; i++ ) ((uint8_t *)input)[45+i] = signature[i];

		// endian swap the block and transform
		sha2_transform_swab32(input, state);

		// read the second block
		#pragma unroll 13
		for( int i=3; i < 16; i++ ) input[i] = g_input[i+16];
...
//			*(uint2*)&input[i] = *(uint2*)&g_input[i+(block << 4)];

//		#pragma unroll 16
//		for( int i=0; i < 16; i++ )
//			input[i] = g_input[i+(block << 4)];

		*(uint2x4*)&input[ 0] = *(uint2x4*)&g_input[0+(block<<4)];
		*(uint2x4*)&input[ 8] = *(uint2x4*)&g_input[8+(block<<4)];
	...
	#pragma unroll 4
        for( int i=0; i < 4; i++ ) *(uint2*)&outputHash[i<<1] = *(uint2*)&state[i<<1];
}

__global__
//__launch_bounds__(TPB, 6)
#if __CUDA_ARCH__ > 500
__launch_bounds__(TPB_88_52, BND_88_52)
#else
__launch_bounds__(TPB_88_50, BND_88_50) 
#endif
void spreadx11_sha256double_gpu_hash_88( int threads, uint32_t startNonce, uint32_t *g_hash )
{
	...
	if (thread < threads){
		...
		#pragma unroll 16
		for( int i = 0; i < 16; i++ ) input[i] = c_PaddedMessage88[i+16];
		input[5] = nonce;
		sha2_transform_swab32(input, state);
		...
		sha2_transform(input, state);
//		*(uint2x4*)&outputHash[ 0] = *(uint2x4*)&state[ 0];
		#pragma unroll 8
		for( int i = 0; i < 8; i++ )
		outputHash[i] = cuda_swab32(state[i]);
	}
}
...
__host__ void spreadx11_sha256double_cpu_hash_88(int thr_id, int threads, uint32_t startNonce, uint32_t *d_hash)
{
    ...
    // const int threadsperblock = 256;
	uint32_t tpb = TPB_88_52;
	if (device_sm[dev_id] <= 500) tpb = TPB_88_50;
...
*/
	...
	for(uint32_t i=32;i<50000;i++){
		((uint32_t*)paddedmessage)[i ] = bswap32(((uint32_t *)paddedmessage)[i]);
	}
...
__host__ void spreadx11_sha256_cpu_hash_wholeblock(int thr_id, int threads, uint32_t startNonce, uint32_t *d_hash, uint32_t *d_signature, uint32_t *d_wholeblock)
{
    ...
    // const int threadsperblock = 256;
	uint32_t tpb = TPBw52;
	if (device_sm[dev_id] <= 500) tpb = TPBw50;
	const dim3 grid((threads + tpb - 1) / tpb);
	const dim3 block(tpb);
