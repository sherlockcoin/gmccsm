...
__device__ __forceinline__ static bool hashbelowtarget(const uint32_t *const __restrict__ hash, const uint32_t *const __restrict__ target)
{
...
#endif
void x11_simd512_gpu_compress_64_maxwell_echo512_final(uint32_t threads,uint32_t startNounce, uint32_t *g_hash, uint4 *g_fft4, uint32_t *d_nonce, int *d_hashidx)
{
...
//		#pragma unroll 4
		...
		*(uint2x4*)&Hash[ 0] = *(uint2x4*)&A[ 0] ^ *(uint2x4*)&W[ 0];
		if (hashbelowtarget(Hash, pTarget) == true){
	            d_nonce[0] = thread+startNounce;
	            d_hashidx[0] = thread;
	        }
	}
}
...
__launch_bounds__(TPB50_2,5)
#endif
void x11_simd512_gpu_compress_64_maxwell_echo512_finaltest(uint32_t threads,uint32_t startNounce, uint32_t *g_hash, uint4 *g_fft4, uint32_t *const __restrict__ d_found, uint64_t target){
...
__host__
uint32_t x11_simd_echo512_cpu_hash_64_final(int thr_id, uint32_t threads,uint32_t startNounce, uint32_t *d_hash, int *hashidx)
{
...
//void x11_simd512_gpu_compress_64_maxwell_echo512_final(uint32_t threads,uint32_t startNounce, uint32_t *g_hash, uint4 *g_fft4, uint32_t *d_nonce, int *d_hashidx)	
	x11_simd512_gpu_compress_64_maxwell_echo512_final <<< grid2, block2 >>> (threads, startNounce, d_hash, d_temp4[thr_id], d_nonce[thr_id], d_hashidx[thr_id]);
...
__host__
void x11_simd_echo512_cpu_hash_64_finaltest(int thr_id, uint32_t threads,uint32_t startNounce, uint32_t *d_hash, uint64_t target, uint32_t *h_found){
	...
	x11_simd512_gpu_expand_64 <<<grid1, block1>>> (threads, d_hash, d_temp4[thr_id]);
//void x11_simd512_gpu_compress_64_maxwell_echo512_finaltest(uint32_t threads,uint32_t startNounce, uint32_t *g_hash, uint4 *g_fft4, uint32_t *const __restrict__ d_found, uint32_t target){
	x11_simd512_gpu_compress_64_maxwell_echo512_finaltest <<< grid2, block2 >>> (threads, startNounce, d_hash, d_temp4[thr_id], d_nonce[thr_id], target);
	cudaMemcpy(h_found, d_nonce[thr_id], sizeof(uint32_t), cudaMemcpyDeviceToHost);
}
