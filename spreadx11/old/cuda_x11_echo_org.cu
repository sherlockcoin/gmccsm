...
__global__ __launch_bounds__(256,4) void x11_echo512_gpu_hash_64_final(int threads, uint32_t startNounce, uint64_t *g_hash, uint32_t *g_nonceVector, uint32_t *d_nonce, int *d_hashidx)
{
	__shared__ uint32_t sharedMemory[1024];
