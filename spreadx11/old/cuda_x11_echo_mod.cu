...
__global__ 
__launch_bounds__(128, 7) /* will force 72 registers */
...
#endif
*/
void x11_echo512_gpu_hash_64_finaltest(uint32_t threads, uint32_t startNounce, uint64_t *const __restrict__ g_hash, const uint32_t *const __restrict__ g_nonceVector, uint32_t *const __restrict__ d_found, uint32_t target)
{
...
__device__ __forceinline__
void echo_gpu_init(uint32_t *const sharedMemory)
{
...
__launch_bounds__(256, 4)
#endif */
void x11_echo512_gpu_hash_64_final(int threads, uint32_t startNounce, uint64_t *g_hash, uint32_t *g_nonceVector, uint32_t *d_nonce, int *d_hashidx)
{
	__shared__ uint32_t sharedMemory[1024];
...
__host__ void x11_echo512_cpu_hash_64_finaltest(int thr_id, uint32_t threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash, uint32_t target, uint32_t *h_found)
{
	...
	x11_echo512_gpu_hash_64_finaltest << <grid, block >> >(threads, startNounce, (uint64_t*)d_hash, d_nonceVector, d_nonce[thr_id], target);
