...
//extern void quark_skein512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash);

//extern void quark_skein512_cpu_hash_64(int thr_id, uint32_t threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash, uint32_t t);
...
//extern void quark_keccak512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash);
//extern void quark_jh512_cpu_init(int thr_id, int threads);
//extern void quark_jh512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash);
...
//extern void x11_luffa512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash);
...
//extern void x11_cubehash512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash);

//extern void x11_shavite512_cpu_init(int thr_id, int threads);
//extern void x11_shavite512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash);
...
//extern void x11_simd512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash);
...
extern void x11_echo512_cpu_hash_64_finaltest(int thr_id, uint32_t threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash, uint32_t target, uint32_t *h_found);
...
//		gettimeofday(&tv_start, NULL);
		quark_groestl512_cpu_hash_64(thr_id, throughput, nonce, NULL, d_hash[thr_id]);
 //       PRINTTIME("groestl");

//		gettimeofday(&tv_start, NULL);
		quark_skein512_cpu_hash_64(throughput, nonce, NULL,d_hash[thr_id]);
 //       PRINTTIME("skein");

//		gettimeofday(&tv_start, NULL);
//		quark_jh512_cpu_hash_64(thr_id, throughput, nonce, NULL, d_hash[thr_id]);
//        PRINTTIME("jh");

//		gettimeofday(&tv_start, NULL);
//		quark_keccak512_cpu_hash_64(thr_id, throughput, nonce, NULL, d_hash[thr_id]);
		cuda_jh512Keccak512_cpu_hash_64(throughput, nonce, d_hash[thr_id]);
		//        PRINTTIME("keccak");

//		gettimeofday(&tv_start, NULL);
		x11_luffaCubehash512_cpu_hash_64(throughput, nonce, d_hash[thr_id]);
 //       PRINTTIME("luffaCubehash");

//		gettimeofday(&tv_start, NULL);
//		x11_luffa512_cpu_hash_64(thr_id, throughput, nonce, NULL, d_hash[thr_id]);
//		PRINTTIME("luffaCubehash");

//		gettimeofday(&tv_start, NULL);
//		x11_cubehash512_cpu_hash_64(thr_id, throughput, nonce, NULL, d_hash[thr_id]);
//       PRINTTIME("cubehash");

//		gettimeofday(&tv_start, NULL);
		x11_shavite512_cpu_hash_64( throughput, nonce, d_hash[thr_id]);
//        PRINTTIME("shavite");

//		gettimeofday(&tv_start, NULL);
		x11_simd512_cpu_hash_64(thr_id,throughput, nonce, d_hash[thr_id]);
 //       PRINTTIME("simd");
...
//		foundNonce = x11_echo512_cpu_hash_64_final(thr_id, throughput, nonce, NULL, d_hash[thr_id], &winnerthread);
   //     PRINTTIME("echo");
		...
		x11_echo512_cpu_hash_64_finaltest(thr_id, throughput, nonce, NULL, d_hash[thr_id], ptarget[7], h_found[thr_id]);
